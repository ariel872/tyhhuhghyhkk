    ...
    try {
      ...
      if (!args[0])
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:no:833101993668771842> You may forward for \`1\` - \`${player.queue.current.duration}\``)
        );
      ...
      return message.channel.send(new MessageEmbed()
        .setTitle(`<a:yes:833101995723194437> ${emoji.msg.forward} Forwarded the Song `)
