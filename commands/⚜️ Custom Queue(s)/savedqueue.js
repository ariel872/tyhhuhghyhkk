    ...
    try {
      ...
      switch (Type.toLowerCase()) {
        case `create`: {
          ...
          return message.channel.send(new MessageEmbed()
            .setTitle(`<a:yes:833101995723194437> Created ${Name}`)
      ...
      case `addcurrentqueue`: {
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a:yes:833101995723194437> Added ${tracks.length} Tracks onto the Queue \`${Name}\``)
      ...
      case `save`: {
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a:yes:833101995723194437> Created ${Name} and Added ${tracks.length} Tracks to it`)
      ...
      case `del`: {
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a:yes:833101995723194437> Deleted the Queue \`${Name}\``)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter(es.footertext, es.footericon)
        )
      }
      ...
      case `paly`: {
        ...
        tempmsg.edit(new MessageEmbed()
          .setTitle(`<a:yes:833101995723194437> Loaded ${client.queuesaves.get(message.author.id, `${Name}`).length} Tracks onto the current Queue`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter(es.footertext, es.footericon)
        )
